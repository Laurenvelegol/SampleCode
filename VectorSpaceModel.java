...
public class VectorSpaceModel {
     ...
     */
    private HashMap<Document1, HashMap<String, Double>> tfIdfWeights;
    ...
    public VectorSpaceModel(Corpus corpus) {
        this.corpus = corpus;
        tfIdfWeights = new HashMap<Document1, HashMap<String, Double>>();
    ...
    private void createTfIdfWeights() {
        ...
        for (Document1 document : corpus.getDocuments()) {
     ...
     */
    private double getMagnitude(Document1 document) {
        double magnitude = 0;
     ...
     */
    private double getDotProduct(Document1 d1, Document1 d2) {
        double product = 0;
     ...
     */
    public double cosineSimilarity(Document1 d1, Document1 d2) {
