...
public class Corpus {
     ...
     */
    private ArrayList<Document1> documents;

    /**
     * The inverted index.
     * It will map a term to a set of documents that contain that term.
     */
    private HashMap<String, Set<Document1>> invertedIndex;
     ...
     */
    public Corpus(ArrayList<Document1> documents) {
        this.documents = documents;
        invertedIndex = new HashMap<String, Set<Document1>>();
    ...
    private void createInvertedIndex() {
        ...
        for (Document1 document : documents) {
            Set<String> terms = document.getTermList();

            for (String term : terms) {
                if (invertedIndex.containsKey(term)) {
                    Set<Document1> list = invertedIndex.get(term);
                    list.add(document);
                } else {
                    Set<Document1> list = new TreeSet<Document1>();
                    list.add(document);
     ...
     */
    public ArrayList<Document1> getDocuments() {
        return documents;
    }
     ...
     */
    public HashMap<String, Set<Document1>> getInvertedIndex() {
